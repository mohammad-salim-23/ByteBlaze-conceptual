...
const Blogs = () => {
  ...
  console.log(blogs)
    return (
      <section className="  dark:bg-gray-800 dark:text-gray-100 bg-gray-50">
      <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
        <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-50">
          ...
          <div className="p-6 space-y-2 lg:col-span-5">
            ...
            <span className="text-xs text-gray-400">{new Date(blogs[0].publish_at).toLocaleDateString()}</span>
